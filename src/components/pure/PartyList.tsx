...
export default function PartyList({ className } : { className?: string } ) {
    ...
    const handleTurn = (i: number) => {
        if (players.length > 0) {
            ...
            newTurn.push(newTurn.splice(1, 1)[0])
            setPlayers(newTurn) */
        }
    }
        ...
        >
            {
                ...
                >
                    <div className="w-full  flex items-center gap-2 p-2 text-start cursor-pointer rounded-md hover:bg-amber-200/50">
                        ...
                        >
                            <svg fill={ players[i] && players[i].turn ? "#fbbf24" : "none" } width="24px" height="24px" version="1.1" viewBox="144 144 512 512" xmlns="http://www.w3.org/2000/svg">
