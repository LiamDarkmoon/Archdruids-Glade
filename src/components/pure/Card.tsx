...
const Card = ({ 
    ...
    const [character, setCharacter] = useState<Character>(new Character({
        name:"Liam Darkmoon", 
        clas:"Druid", race:"Human", 
        background:"Sage", 
        alignment:"Neutral", 
        stats: [16, 18, 18, 10, 18, 10]
    }))
    ...
    return (
        ...
        <motion.div
            ...
            className={ className + " relative h-[375px] w-[250px] flex flex-col items-center justify-end rounded-md bg-opacity-45"}
        >
        ...
        <motion.div
            ...
            className={ className + " relative h-[375px] w-[250px] flex flex-col items-center justify-end rounded-md bg-opacity-45 border border-rose-950"}
        >
            <Image src={ img } className="h-full w-full rounded-md" width={ 200 } height={ 200 } alt={ title }/>
            <CardBody className="absolute flex flex-col bg-amber-100 bg-opacity-80 h-full w-full p-6">
