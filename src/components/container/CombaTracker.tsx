  ...
  return (
    <section className="h-[100vh] w-full px-12 mt-[100px] text-amber-50 flex flex-col text-center">
      <div className="flex flex-col sm:flex-row flex-wrap gap-5">
        <div className="sm:w-3/5 p-6 border border-amber-100/30 bg-amber-100/40 glass rounded-lg shadow-md">
        ...
        <div className="sm:w-[30%] p-6 border border-amber-100/30 bg-amber-100/40 glass rounded-lg shadow-md">
