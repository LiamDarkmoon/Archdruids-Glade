...
export default function Home() {
  return (
    <main className="flex w-full min-h-screen flex-col items-center justify-between bg-emerald-50">
      <section className="bg-jungle bg-no-repeat bg-cover flex flex-wrap w-full items-center justify-evenly pt-28 sm:py-20">
        <div className="w-full sm:w-2/5 p-5  text-red-50">
          <h5 className="text-sm pb-2 mb-2 border-b text-red-60000 border-red-600">Welcome to the</h5>
